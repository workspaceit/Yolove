        ...
        <div class="col-lg-4 col-sm-5 col-xs-12 col-md-4">
            <div class="pull-right full-xs">
                <ul class="nav navbar-nav navbar-right set-li">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle visible-lg visible-md visible-sm" data-toggle="dropdown"><label class="label-flag"> SINGAPORE</label><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="pose-rel"><a href="javascript:void(0);" data-url="{{$main_url}}?{{http_build_query($sessionData)}}" class="gotoCountry"><label class="label-flag"> USA</label></a></li>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div id="navbar" class="navbar-collapse collapse fix-submenu-pad" style="display:block; margin-top:5px;">
                <ul class="nav navbar-nav fix-sub-list">
                    ...
                    <li><a href="<?php echo URL::to('/'); ?>/beauty">Beauty</a></li>
