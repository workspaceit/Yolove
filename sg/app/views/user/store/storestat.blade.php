                ...
                <div class="item-description title-add" style="min-height: 60px !important;height: 70px !important;">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="" placeholder="" value="S${{$profit}}" id="profit">
                        </div>
                    </div>
                </div>
                ...
                <div class="item-description title-add" style="min-height: 60px !important;height: 70px !important;">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="" placeholder="" value="S${{$profit1}}" id="comparison">
                        </div>
                    </div>
                </div>
                ...
                <div class="item-description title-add" style="min-height: 60px !important;height: 70px !important;">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="" placeholder="" value="S${{$profit2}}" id="comparison">
                        </div>
                    </div>
                </div>
                ...
                <div class="item-description title-add" style="min-height: 60px !important;height: 70px !important;">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="" placeholder="" value="S${{$comparison}}" id="comparison">
                        </div>
                    </div>
                </div>
