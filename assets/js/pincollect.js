...
//		form.appendChild(allbtn);
	...
	var a = "__pinit", b = "http://yolove.it",host="yolove.it",logo = b+"/assets/images/right-icon.png", data_action = b+"/fetchUrl?fetch="+remoteUrl, d = this.location, e = d.host, f = function() {},
