...
//        var thisObj = $(this);
//        var sid = thisObj.attr('data-id');
//        var type = thisObj.attr('data-key');
//        var socialButton = thisObj.attr('data-social');
//        socialShare(sid, type, socialButton);
//    })
//
//    function socialShare(sid, type, socialButton) {
//        obj = JSON.parse(socialButton);
//        var sharebutton = [];
//        sharebutton[type] = {'link': obj.link, 'width': obj.width, 'height': obj.height};
//        console.log(sharebutton);
//        var site_name = encodeURIComponent("Yolove.it");
//        var window_name = 'social_share';
//        var img = $('#' + sid + '_image').find('img');
//        console.log(img.length);
//        var img_url = "";
//        img_url = $(img[0]).attr('src');
//        console.log(img_url);
//        //var link = $('#' + sid + '_image').attr('data-link');
//        var link = decodeURI(document.URL);
//        //                    if (img.length > 0) {
//        //                        img_url = $(img[0]).attr('src')
//        //                    }
//        var desc_text = $('#' + sid + '_share_desc').text();
