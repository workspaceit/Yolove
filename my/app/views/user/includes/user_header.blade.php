        ...
        <div class="col-lg-4 col-sm-5 col-xs-12 col-md-4">
            <div class="pull-right full-xs">
                <ul class="nav navbar-nav navbar-right set-li">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle visible-lg visible-md visible-sm" data-toggle="dropdown"><label class="label-flag"> MALAYSIA</label><span class="caret"></span></a>
                        <ul class="dropdown-menu">
