                            ...
                            <div class="row col-md-12 total-price">
                                <table class="table summary-table">
                                    <tbody>
                                        <tr>
                                            <th>Total cost</th>
                                            <td>RM{{$_SESSION[$response['cartuser']]['totalPrice']}}</td>
                                        </tr>
                                        <tr>
                                            <th>Shipping cost</th>
                                        ...
                                        if (isset($_SESSION[$response['cartuser']]['totalDiscount'])) {
                                            ...
                                            <tr id="discountDiv">
                                                ...
                                                <td id="totalDiscount">RM{{$_SESSION[$response['cartuser']]['totalDiscount']}}</td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                    <tfoot>
