...
class AppController extends Controller {
    ...
    function beforeFilter() {
        ...
        $this->apiPath = $_SERVER['DOCUMENT_ROOT'] . "/yolove_api/my/";
        ...
        if ($_SERVER['SERVER_NAME'] == "localhost" || $_SERVER['SERVER_NAME'] == "workspaceit.com") {
            $this->apiUrl = $domain . "/yolove_web/yolove_api/my/";
            $this->siteUrl = $domain. "/yolove_web/my/";
        } else {
            $this->apiUrl = $domain . "/yolove_api/my/";
            $this->siteUrl = $domain."/my/";
        }
