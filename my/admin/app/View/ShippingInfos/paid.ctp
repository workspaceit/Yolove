...
<h4 class="green"><i class="icon-tags green"></i>Manage Paid Cart</h4>
...
<script type="text/javascript">
    $(function() {
        ...
        $('#admin_paidCart').on('click', '.changeVerification', function(e) {
            e.preventDefault();
            var $this = $(this);
    ...
    $(document).ready(function() {
        ...
        $('#sample-table-2_length select').change(function() {
            ...
            window.location = "<?php echo $this->webroot; ?>ShippingInfos/paid/" + limits;
        });
    });
</script>
