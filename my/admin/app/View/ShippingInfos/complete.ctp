...
<h4 class="green"><i class="icon-tags green"></i>Manage Complete Cart</h4>

<?php echo $this->Session->flash(); ?>
<div class="row-fluid">

    <div class="span12 table_action" id="admin_completeCart">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#admin_completeCart').on('click', '.changeVerification', function(e) {
            e.preventDefault();
            var $this = $(this);
    ...
    $(document).ready(function() {
        ...
        $('#sample-table-2_length select').change(function() {
            ...
            window.location = "<?php echo $this->webroot; ?>ShippingInfos/complete/" + limits;
        });
    });
</script>
