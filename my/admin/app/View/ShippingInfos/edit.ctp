<div class="shippingInfos form">
    ...
    <fieldset>
        <legend><?php echo __('Edit Shipping Info'); ?></legend>
        <?php
...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ShippingInfo.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ShippingInfo.id'))); ?></li>
